   ...
   return (
      <div className="space-y-6 text-cyberteal-text">
         ...
         <p className="text-cyberteal-muted">
            Based on your project requirements, here's a curated tech stack to
            help you build efficiently:
         </p>
            ...
            {tools.map((category, index) => (
               ...
               >
                  <div className="mb-3 flex items-center space-x-2">
                     ...
                     <h3 className="font-medium text-cyberteal-text">
                        {category.name}
                     </h3>
                  </div>
                     ...
                     {category.tools.map((tool, toolIndex) => {
                        return (
                           ...
                           >
                              ...
                              <div className="text-sm text-cyberteal-muted">
                                 {tool.description}
                              </div>
                           </div>
                        );
         ...
         <div className="rounded-lg border border-cyberteal-secondary/20 bg-cyberteal-secondary/5 p-4">
            ...
            <p className="text-sm text-cyberteal-muted">
               Start with the core infrastructure tools first, then add
               development and community tools as your project grows. Many of
               these tools offer free tiers or startup programs that can help
